...
(function () {
    ...
    function H(a) {
        if (0 === a.Pa.length)
            return null;
        var b = a.Pa.pop(), c;
        c = a.Rd ? a.Rd(b.key, b.value) : {key: b.key, value: b.value};
        if (a.Ee)
            for (b = b.left; !b.e(); )
    ...
    function ec(a) {
        ...
        b = a.Pa;
        b = b[b.length - 1];
        return a.Rd ? a.Rd(b.key, b.value) : {key: b.key, value: b.value}
    }
    ...
    h.parent = function () {
        if (this.Y >= this.o.length)
            return null;
        for (var a = [], b = this.Y; b < this.o.length - 1; b++)
            a.push(this.o[b]);
        return new K(a, 0)
    };
    h.w = function (a) {
    ...
    function Rc(a) {
        ...
        return{host: b, port: k, domain: c, Qg: d, lb: f, scheme: g, Zc: e}
    }
    function Sc(a) {
    ...
    h.ta = function (a, b, c) {
        ...
        if (b.N() || b.e())
            ...
            if (this.Jb) {
                ...
                b = d.Wb(this.g), k = this.ra.dd,
                        l = this.ra.Fc, m = ud(this.g);
            for (var e = 0, y = !1; 0 < b.Pa.length; )
    ...
    zd.prototype.bb = function (a, b, c, d) {
        ...
        if (b.type === Vb)
            ...
            throw Hc("Unknown operation type: " +
                    b.type);
        e = ra(e.eb);
        d = c;
        b = d.D;
    ...
    function Gd(a, b, c, d, e, f) {
        ...
        if (Hb(b.u())) {
            ...
            l = O(c);
            if (1 == uc(c) || rb(b.D, l))
                c = d.Xa(l, b.u()), null != c && (k = a.I.G(e, l, c,
                        g, f));
            e = !1
        }
    ...
    h.K = function (a) {
        return a && !this.A().e() ? {".value": this.Ba(), ".priority": this.A().K()} : this.Ba()
    };
    h.hash = function () {
        if (null === this.Bb) {
            var a = "";
    ...
    h.Xb = function (a, b) {
        ...
        for (var c = this.m.Xb(a.name, Qb), d = ec(c); null != d && 0 > b.compare(d, a); )
            H(c), d = ec(c);
        return c
    };
    h.rf = function (a) {
    ...
    h.Zb = function (a, b) {
        ...
        for (var c = this.m.Zb(a.name, Qb), d = ec(c); null != d && 0 < b.compare(d, a); )
            H(c), d = ec(c);
        return c
    };
    h.Cc = function (a) {
    ...
    h.mb = function (a) {
        ...
        for (var d = [], e = !1, c = c.Wb(Qb), f = H(c); f; )
    ...
    function pf(a) {
        ...
        return{Ib: a.substr(b + 1), path: new K(a.substr(0, b))}
    }
    function of(a, b) {
        var c = a.$e, d = "_" + b;
    ...
    function zf(a, b, c, d, e) {
        ...
        if ((c = c.children.get(k)) && l)
            var m = d ? d.M(k) : null, k = e.w(k), g = g.concat(zf(a, l, c, m, k));
    ...
    If.prototype.de = function (a, b) {
        for (var c = this.Nc[a] || [], d = 0; d < c.length; d++)
    ...
    ug.prototype.hc = function (a) {
        ...
        c && "request" === c.a && (pg(window, "message", this.hc), this.ae = a.origin, this.zc && setTimeout(function () {
            b.zc(b.ae, c.d, function (a, c) {
                b.ag = !c;
                b.zc = void 0;
                vg(b, {a: "response", d: a, forceKeepWindowOpen: c})
            })
        }, 0))
    };
    ...
    Bg.prototype.open = function (a, b, c) {
        ...
        (g = window.open(a, "_blank", "location=no")) && ha(g.addEventListener) ? (g.addEventListener("loadstart", function (a) {
            ...
            b && (a = rg(a.url), g.removeEventListener("exit",
                    d), g.close(), a = new gg(null, null, {requestId: e.oc, requestKey: a}), e.Df.requestWithCredential("/auth/session", a, c), c = null)
    ...
    function Gg(a) {
        ...
        if (b) {
            ...
            var d = [Ag, Cg], b = {requestId: b, requestKey: rg(document.location.hash)}, c = new gg(c, {}, b);
            a.Re = !0;
            try {
    ...
    h.send = function (a) {
        ...
        for (var b = 0; b < a.length; b++) {
            var c = this.Ta;
            c.$c.push({Jg: this.gf, Rg: a.length, jf: a[b]});
            c.ke && $g(c);
            this.gf++
        }
    };
    ...
    ch.prototype.open = function (a, b) {
        ...
        this.va.onmessage = function (a) {
            if (null !== e.va)
                if (a = a.data, e.ob +=
                        a.length, Lb(e.Va, "bytes_received", a.length), eh(e), null !== e.frames)
                    fh(e, a);
                else {
                    a:{
            ...
            if (2 != a.Ua)
                if (b === a.bd) {
                    ...
                    if (d = Vc("t", c), c = Vc("d", c), "c" == d)
                        "t"in c && (c = c.t, "a" === c ? uh(a) : "r" === c ? (a.f("Got a reset on secondary, closing it"), a.F.close(), a.fd !== a.F && a.bd !== a.F || a.close()) : "o" === c && (a.f("got pong on secondary."),
                                a.Lf--, uh(a)));
                    else if ("d" == d)
                        a.Jd.push(c);
                    else
    ...
    function uh(a) {
        0 >= a.Lf ? (a.f("Secondary connection is healthy."), a.Ab = !0, a.F.Bd(), a.F.start(), a.f("sending client ack on secondary"), a.F.send({t: "c", d: {t: "a", d: {}}}), a.f("Ending transmission on primary"), a.L.send({t: "c", d: {t: "n", d: {}}}), a.fd = a.F, qh(a)) : (a.f("sending ping on secondary."), a.F.send({t: "c", d: {t: "p", d: {}}}))
    }
    ...
    function th(a) {
        a.Ab || 1 !== a.Ua || (a.f("sending ping on primary."), vh(a, {t: "c", d: {t: "p", d: {}}}))
    }
    function vh(a, b) {
        if (1 !== a.Ua)
    ...
    h.Le = function (a, b, c) {
        this.ma ? Dh(this, "o", a, b, c) : this.Uc.push({Zc: a, action: "o", data: b, J: c})
    };
    h.Bf = function (a, b, c) {
        this.ma ? Dh(this, "om", a, b, c) : this.Uc.push({Zc: a, action: "om", data: b, J: c})
    };
    h.Gd = function (a, b) {
        this.ma ? Dh(this, "oc", a, null, b) : this.Uc.push({Zc: a, action: "oc", data: null, J: b})
    };
    ...
    function Kh(a, b) {
        ...
        this.Be =
                new nb;
        var c = this;
        this.zd = new gf({Xe: function (a, b, f, g) {
                b = [];
                f = c.Be.j(a.path);
        ...
        this.pd = 0;
        this.Ce = null;
        this.O = new gf({Xe: function (a, b, f, g) {
    ...
    h.Kb = function (a, b, c, d) {
        this.f("set", {path: a.toString(), value: b, Xg: c});
        var e = Nh(this);
        b = L(b, c);
    ...
    function Wh(a, b, c, d, e) {
        ...
        var g = new U(a, b);
        g.Eb("value", f);
        c = {path: b, update: c, J: d, status: null, Ef: Gc(), cf: e, Kf: 0, ge: function () {
                g.gc("value", f)
    ...
    function ai(a, b) {
        for (var c, d = a.tc; null !== (c = O(b)) && null === d.Ba(); )
            d = Df(d, c), b = G(b);
        return d
    }
    function Zh(a, b) {
    ...
    Y.prototype.toString = function () {
        ...
        for (var a = this.path, b = "", c = a.Y; c < a.o.length; c++)
