...
$(document).ready(function () {
	...
	$("body").on('click', "div.help.col-xs-4.col-sm-4.col-md-4.altura-poema > h3 > span:contains('+')", function(){ 
		...
		if (text.length > 0){
			...
			$(this).before('<span class="label label-info" style="float:left; margin: 3px; opacity:0" title="click para eliminar">' + text + '</span>');
			$(this).prev().animate({ opacity: '1'}, "2000");
		}       
	});

	//remove palavra da ajuda do poema
	$("body").on('click', "div.help.col-xs-4.col-sm-4.col-md-4.altura-poema > h3 > span:not(:contains('+'))", function(){ 
		$(this).remove();     
	});
