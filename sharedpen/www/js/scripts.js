...
//        console.log(textPdf);
    ...
    $('#bt_HTML').click(function () {
        ...
        $('#tabs > li > a').each(function () {
            var page = "";
			$($(this).attr("href")).children().children().each(function () {
				var idDiv = this.id;
...
// cada um e controi a tabela
                var tableusers = "<h3>Alunos que contribuiram para a realização deste trabalho.</h3>" +
                        "<table class='contribuidores'>";
                tableusers += "<thead><tr><th>Imagem</th><th>Nome</th></tr></thead><tbody>";
                for (var i in data) {
...
// cada um e controi a tabela
                var tableprofs = "<h3>Professores que participaram neste trabalho.</h3>" +
                        "<table class='contribuidores'>";
                tableprofs += "<thead><tr><th>Imagem</th><th>Nome</th></tr></thead><tbody>";
                for (var i in data) {
...
//            console.log(backArray + " " + currentPosition);
	...
	///////////////////////////////////////////////////////////////////////////////////////
	 /**
     * seletor para selecionar a moldura para a criacao do projeto
     */
    $("body").on("click", ".selectMolduras", function () {
            $("body").find("#MolduraSelectPagina").attr("src", $(this).attr("src"));
            $("body").find("#MolduraSelectPagina").attr("data-model", $(this).data("model"));
            $("body").find("#MolduraSelectPagina").attr("data-idmodel", $(this).data("idmodel"));
...
function refactorTab(html, idNum, estilos, mold) {
	...
	$(".txtTab" + idNum).children('div').attr("style", "background:url("+mold+"); background-size: 100% 100% ");
...
///////////////////////////////////////////////////////////////////////////////////////////////			
				 $.ajax({
                    ...
                    success: function (data) {
                        ...
                        for (var i = 0, max = data.length; i < max; i++) {
                            listLayout += "<figure>" +
                                    "<img class='selectMolduras btnmodels-style' alt='' src='" +
                                    (data[i].icon == null ? "./img/" + data[i].nome + ".png" : data[i].icon) +
                                    "' data-idmodel='" + data[i].id +
                                    "' data-model='" + data[i].nome + "'/>" +
                                    "<figcaption> " + data[i].nome + " </figcaption>" +
                        ...
                        listLayout += "</div>";
                        $("body").find("#loading").remove();
                        $("body").find("#painelMolduras").append(listLayout);
...
function save_html(data, back_image) {
    ...
    var styleEnd = "body{    overflow:hidden;}#flipbook{    width:100%;    height:100%;}#flipbook .page{    width:100%;    height:100%;        line-height:1em;    font-size:20px;    text-align:center;}#flipbook .page-wrapper{    -webkit-perspective:2000px;    -moz-perspective:2000px;    -ms-perspective:2000px;    -o-perspective:2000px;    perspective:2000px;}#flipbook .hard{    background:#ccc !important;    color:#333;    -webkit-box-shadow:inset 0 0 5px #666;    -moz-box-shadow:inset 0 0 5px #666;    -o-box-shadow:inset 0 0 5px #666;    -ms-box-shadow:inset 0 0 5px #666;    box-shadow:inset 0 0 5px #666;    font-weight:bold;}#flipbook .odd{" + back_image + ";    -webkit-box-shadow:inset 0 0 5px #666;    -moz-box-shadow:inset 0 0 5px #666;    -o-box-shadow:inset 0 0 5px #666;    -ms-box-shadow:inset 0 0 5px #666;    box-shadow:inset 0 0 5px #666;    }#flipbook .even{" + back_image + ";    -webkit-box-shadow:inset 0 0 5px #666;    -moz-box-shadow:inset 0 0 5px #666;    -o-box-shadow:inset 0 0 5px #666;    -ms-box-shadow:inset 0 0 5px #666;    box-shadow:inset 0 0 5px #666;}p {    height: 20px;}.dragandrophandler {    	    width:400px;    color:#92AAB0;    text-align:left;vertical-align:middle;font-size:200%;}canvas{    position: absolute;}#canvasdr{    position: relative;    overflow: hidden;    overflow-y: scroll;}.tabpage {    border: 1px solid black;    width: 210mm;    height: 297mm;    padding: 20px;    margin: auto;}.tabpage > .titulo, .titulo1, .titulo2, .titulo3, .titulo4, .titulo5, .titulo6, .titulo7 {	font-size: 32px;	text-align: center;}.titulo {       height: 30%; width: 90%;  margin-top: 5%;	margin-left: 5%;	margin-right: 5%;	margin-bottom: 5%;    	}.titulo1 {    float: left;    width: 45%;    height: 50%;    margin-top: 50px; margin-right: 15px; margin-left:15px;}.titulo2 {    width: 200mm;    height: 70mm;    margin-top: 20px;}.titulo3 {	float: left;    width: 39%;    height: 40%;    margin-top: 5%;	margin-left: 5%;	margin-right: 5%;	margin-bottom: 5%;}.titulo4 {	float: left;    width: 40%;    height: 40%;    margin-top: 5%;	margin-left: 5%;	margin-right: 5%;	margin-bottom: 5%;}.titulo5 {	width: 90%;    height: 50%;    margin-top: 5%;	margin-left: 5%;	margin-right: 5%;	margin-bottom: 5%;}.titulo6 {	width: 90%;    height: 20%;    margin-top: 5%;	margin-left: 5%;	margin-right: 5%;	margin-bottom: 5%;}.titulo7 {	height: 30%; width: 90%;  margin-top: 5%;	margin-left: 5%;	margin-right: 5%;	margin-bottom: 5%;}img {	border: 1px solid black;                    -moz-box-shadow:    inset 0 0 5px #000000;    -webkit-box-shadow: inset 0 0 5px #000000;    box-shadow:         inset 0 0 5px #000000;}.image {    height: 50%;	width: 50%;    margin-top: 5%;	margin-left: 5%;	margin-right: 5%;	margin-bottom: 5%;}.image1 {     float: left;    height: 40%;	width: 40%;    margin-top: 50px;	margin-left: 15px;	margin-right: 15px;}.image2 {        margin-left: 30px;	margin-right: 30px;	height: 30%;	width: 30%;}.image3 {	float: left;    height: 40%;	width: 40%;    margin-top: 5%;	margin-left: 5%;	margin-right: 5%;	margin-bottom: 5%;}.image4 {	float: left;    height: 40%;	width: 39%;    margin-top: 5%;	margin-left: 5%;	margin-right: 5%;	margin-bottom: 5%;    }.image5 {	display: block;    margin: 0 auto;    height: 30%;    margin-top: 50px;    width: 30%;}.image6 {	display: block;    margin: 0 auto;    height: 30%;    margin-top: 20px;    width: 30%;}.conteudo {	margin-top: 50px;	margin-right: 500px;	margin-left: 50px;    width: 90%;    height: 90%;} .tabpage > div, .tabpagedraw > input {    width: 100%;    border: 1px solid black;                    -moz-box-shadow:    inset 0 0 5px #000000;    -webkit-box-shadow: inset 0 0 5px #000000;    box-shadow:         inset 0 0 5px #000000;}.tabpagedraw {    border: 1px solid black;    width: 210mm;    height: 297mm;    padding: 20px;    margin: auto;}.tabpagedraw > input {    height: 40px;    text-align: center;    font-size: xx-large;    margin-top: 50px;}.tabpagedraw > canvas {    border: 1px solid black;    width: 100%;    height: 700px;    margin-top: 30px;}input[type=file] {    display: none;}.empty {	float:left;	height: 0mm;    margin-top: 0px;    width: 200mm;	border: 0px;}body{background-color:#AAAAFF;}p {font-size:86%; margin-bottom: 3px; margin-top:auto;} table.contribuidores{		border: solid 1px #DDEEEE;    	border-collapse: collapse;    	border-spacing: 0;    	margin-left: auto;		margin-right: auto;	}    table.contribuidores thead th {    	background-color: #DDEFEF;    	border: solid 1px #DDEEEE;    	color: #336B6B;    	padding: 10px;    	text-align: left;    	text-shadow: 1px 1px 1px #fff;		font: normal 18px Arial, sans-serif;}	table.contribuidores tbody td {    	border: solid 1px #DDEEEE;    	color: black;    	padding: 10px;    	text-shadow: 1px 1px 1px #fff;    	border-left: none;    	border-right: none;		font: normal 28px Arial, sans-serif;	}	table.contribuidores tbody td img{		margin:0 20px 0 0px;		}	h3{		font: normal 20px Arial, sans-serif;   margin-top:40px;	}</style>";
